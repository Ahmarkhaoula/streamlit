...
def main():
    ...
    df = pd.read_parquet(r'D:\iav\3ci\S5\web_mapping\projet_streanlit\donnee\Hotels.parquet')
    ...
    folium_static(carte, width=800, height=600)
    ...
    if st.button("Validate selection"):
        ...
        if selected_hotel_index is not None:
            ...
            fig = px.line(x=["J-6", "J-5", "J-4", "J-3", "J-2", "J-1", "J"] * 3,
                          y=reshaped_data,

...
def app():
    ...
    carte = None
    try:
        df = pd.read_parquet(r"D:\iav\3ci\S5\web_mapping\streamlit\donnee\Hotels.parquet", engine='fastparquet')
        ...
        if carte_type == 'Graduated symbols':
            ...
            with col2:
                image = Image.open(
                    r"D:\iav\3ci\S5\web_mapping\streamlit\donnee\WhatsApp Image 2023-11-26 at 20.49.29.jpeg")
